...
🧩 Working Style
복잡한 문제를 구조화하고, 이해관계자별 관점을 정리합니다.
고객의 요청을 그대로 옮기기보다 실제 문제와 목적을 먼저 정의합니다.
기능, 정책, 운영 프로세스가 함께 작동하는 제품 경험을 고민합니다.
기술적 제약과 비즈니스 목표 사이에서 현실적인 실행안을 찾습니다.
작은 개선이라도 기록, 회고, 반복을 통해 다음 의사결정의 근거로 남깁니다.
🛠 Tools & Collaboration
Notion
Jira
Trello
...
개발자처럼 직접 모든 것을 구현하는 것보다,
제품과 기술이 만나는 지점을 정확히 이해하고 소통하는 데 집중합니다.

서비스 구조, API, 데이터베이스, 배포 환경에 대한 이해를 바탕으로
기획의 완성도와 협업의 정확도를 높이고 있습니다.
...
<a href="mailto:krjoshua21@gmail.com"> <img src="https://img.shields.io/badge/Contact_Me-EA4335?style=for-the-badge&logo=gmail&logoColor=white"/> </a> </div>
